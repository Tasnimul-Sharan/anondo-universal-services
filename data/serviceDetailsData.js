  ...
  serviceDetails: [
    {
      ...
      services: {
        ...
        checklist: [
          ...
          "Round-the-clock doctors and nurses available.",
          "Physiotherapy & Occupational Therapy Units",
          "Emergency care unit with a dedicated medical helicopter for urgent evacuation",
        ],
        subImages: [
    ...
    },
    {
      ...
      services: {
        ...
        checklist: [
          ...
          "Buffet and customized menus.",
          "Herbal beverages and fruit juices.",
        ...
        quote: "Food is medicine when prepared with care.",
        postTags: ["Dining", "Nutrition", "Healthy Living"],
      },
    },
    {
      slug: "recreation",
    ...
    },
    {
      ...
      services: {
        ...
        checklist: [
          ...
          "Open-air pavilions for rest and meditation.",
          "Fruit orchards and flower gardens.",
          "Dedicated park zones for family visits.",
          "Bird-watching spots and koi ponds.",
        ],
        subImages: [
          "/services/features/landscape1.jpg",
          "/services/features/landscape2.jpg",
        ],
        quote: "Nature is the best healer of the soul.",
        postTags: ["Landscaping", "Nature", "Environment"],
      },
    },
    {
      slug: "admission",
