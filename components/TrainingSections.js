...
//           <strong> Training Academy</strong>, a dedicated facility where men and women are
//           transformed into disciplined, skilled, and confident security professionals.
//         </p>
...
//           <h3 className="text-xl font-medium mb-2">Training Ground (2+ acres)</h3>
//           <p className="text-gray-600">Large open fields for parades, fitness drills, and martial arts sessions.</p>
//         </div>

//         <div className="p-6 rounded-xl bg-gradient-to-br from-slate-50 to-white/60 shadow-md">
//           <h3 className="text-xl font-medium mb-2">Dormitory Facilities</h3>
//           <p className="text-gray-600">Long-stay accommodation supporting a disciplined 45-day residential program.</p>
//         </div>

//         <div className="p-6 rounded-xl bg-gradient-to-br from-slate-50 to-white/60 shadow-md">
//           <h3 className="text-xl font-medium mb-2">Classrooms & Simulation Areas</h3>
//           <p className="text-gray-600">Lecture halls, vehicle check zones, and CCTV monitoring rooms for hands-on learning.</p>
//         </div>
//       </div>
...
//         <p className="text-gray-600 mb-6">The program is structured around four major components — Field, Professional, Theoretical, and Personal Development.</p>
...
//               <li><strong>Physical Fitness:</strong> Daily routines (running, push-ups, rope-climbing) and nutrition guidance.</li>
//               <li><strong>Parade & Drill:</strong> Marching, formations and ceremonial readiness.</li>
//               <li><strong>Discipline:</strong> Punctuality, responsibility and professional accountability.</li>
//               <li><strong>Self-Defence & Martial Arts:</strong> Safe restraint techniques and unarmed combat basics.</li>
//             </ul>
//           </article>
...
//             <ul className="list-disc pl-5 text-gray-700 space-y-2">
//               <li><strong>Access Control & Visitor Checks</strong> — respectful frisking, screening and entry management.</li>
//               <li><strong>Object & Vehicle Screening</strong> — practical use of scanners and under-vehicle checks.</li>
//               <li><strong>Crowd Control & Event Security</strong> — safe crowd management and coordination with authorities.</li>
//               <li><strong>CCTV Surveillance</strong> — monitoring, detection and reporting workflows.</li>
//             </ul>
//           </article>
...
//           <p className="text-gray-700 mt-2">Graduates emerge as physically fit, legally aware, professionally skilled, and ethically grounded guards — ready to inspire trust and confidence.</p>
//         </div>
//       </div>
...
//             <div className="h-36 rounded-md bg-gradient-to-br from-slate-100 to-white flex items-center justify-center text-sm text-gray-500">Image: {v.title}</div>
...
//           <a href="/contact" className="px-5 py-2 rounded-lg border bg-white hover:shadow-sm">Contact Us</a>
//           <a href="/brochure.pdf" className="px-5 py-2 rounded-lg bg-sky-600 text-white">Download Brochure</a>
//         </div>
//       </div>
//     </section>
//   );
