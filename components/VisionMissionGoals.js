...
export default function VisionMissionGoals() {
  const items = [
    {
      title: "Our Vision",
      desc: "To be the most trusted security service provider in South Asia, delivering innovative, reliable, and people-focused protection solutions.",
      icon: <FaEye className="size-12" aria-hidden />,
    },
    {
      title: "Our Mission",
      desc: "To ensure safety and peace of mind through professionalism, technology, and uncompromising integrity.",
      icon: <FaShieldAlt className="size-12" aria-hidden />,
    },
    {
      title: "Our Goals",
      desc: "We translate our mission into action with measurable goals for safety, efficiency, and excellence.",
      // points: [
      //   "Deploy 2000+ trained security professionals nationwide",
      //   "Provide 24/7 Central Command & Monitoring",
      //   "Deliver tailored solutions for corporate, industrial, and event security",
      //   "Maintain regular training & skill development programs",
