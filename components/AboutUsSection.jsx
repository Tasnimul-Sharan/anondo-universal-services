...
export default function AboutSecuritySection() {
 ...
 <h2 className="md:text-4xl text-2xl font-bold mb-4 leading-tight text-secondary">
        Professional Security <br className="hidden md:inline" /> Services You Can Trust
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            At <span className="font-semibold">Anondo Universal Services Limited</span>, 
            we provide world-class security and facility solutions to protect lives, 
            businesses, and assets. With highly trained personnel, modern technology, 
            and round-the-clock support, we deliver trust, reliability, and peace of mind. 
            Our mission is clear — <em>your safety, our responsibility</em>.
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Skilled, disciplined, and professional security officers 
                  for every situation.
                </p>
              </div>
            </div>
